...
class ForcestartSubCommand extends BaseSubCommand
{
    ...
    {
        $this->setPermission("bedwars.command.forcestart");
    }
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        $arena->setTimer(5);
        $sender->getServer()->broadcastMessage("Arena will start in 5 seconds due to a forced start by " . $sender->getDisplayName(), $arena->getPlayers());
    }
}
